          ...
          <tbody>
            @foreach($banners as $banner)   
                <tr>
                    ...
                    <td>{{$banner->slug}}</td>
                    <td>
                  {{$banner->bannerImages->image_name}}
                @if (!empty($banner->bannerImages) && !empty($banner->bannerImages->image_name))
                 
                <img src="{{ asset('public/banner_image/'.$banner->bannerImages->image_name) }}"  class="img-fluid zoom" style="max-width:80px" alt="{{ $banner->bannerImages->image_name }}">
                @else
                <!-- value isd to fix if going ito else need -->
