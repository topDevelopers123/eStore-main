      ...
      <form method="post" action="{{route('product.update',$product->id)}}" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <select name="size[]" class="form-control selectpicker"  multiple data-live-search="true">
              ...
              <option value="XXL"  @if( in_array( "XXL",$data ) ) selected @endif>Double Large</option>
              <option value="3XL"  @if( in_array( "3XL",$data ) ) selected @endif>Triple Large</option>
              <option value="4XL"  @if( in_array( "4XL",$data ) ) selected @endif>Four Large</option>
              @endforeach
          </select>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input id="images" class="form-control" type="file" name="photo" value="{{ old('photo') }}">
        </div>
