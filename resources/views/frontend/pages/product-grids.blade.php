                        ...
                        <div class="single-widget recent-post">
                            ...
                            <div class="single-post first">
                                <div class="image">
                                    ...
                                    <img src="{{ asset('public/product_image/'.$product->product_image->image_name) }}" class="img-fluid zoom" style="max-width:100%" alt="$product->product_image->image_name">
                                    @else
                            ...
                            <div class="single-product single_product_div mt-0 border rounded">
                                <div class="product-img col-sm-12 col-md-12 col-lg-12 px-0 d-flex justify-content-center align-items-center">
                                    <a href="{{route('product-detail',$product->slug)}}" class="p-2">
                                        ...
                                        <img src="{{ asset('public/product_image/'.$product->product_image->image_name) }}" class="img-fluid img_section zoom " style="max-width:100%; max-height:250px;" alt="$product->product_image->image_name">
                                        @else
                                        <img src="{{asset('backend/img/thumbnail-default.jpg')}}" class="img-fluid" style="max-width:80px" alt="avatar.png">
                                ...
                                <div class="product-content px-2">
                                    <h3 class=""><a href="{{route('product-detail',$product->slug)}}" class="
                                                ">{{$product->title}}</a></h3>
                                    @php
