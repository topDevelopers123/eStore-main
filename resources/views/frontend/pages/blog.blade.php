                        ...
                        {{-- {{$post}} --}}
                            <div class="col-lg-6 col-md-6 col-12">
                                ...
                                <div class="shop-single-blog">
                                    @if (!empty($post->product_image) && !empty($post->product_image->image_name))
                     
                                    <img src="{{ asset('public/product_image/'.$post->product_image->image_name) }}"  class="img-fluid " style="max-width:100%; max-height:100%;" alt="$product->product_image->image_name">
                                  @else
