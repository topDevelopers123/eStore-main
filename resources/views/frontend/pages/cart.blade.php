					...
					<table class="table shopping-summery">
						<thead>
							<tr class="main-hading ">
								...
								<th class="text-right "><i class="ti-trash remove-icon mr-5"></i></th>
							</tr>
						</thead>
								...
								@if(Helper::getAllProductFromCart())
									@foreach(Helper::getAllProductFromCart() as $key=>$cart)
										<tr>
											...
											@endphp --> --}}
											<td>
											{{-- {{$cart->product_image->image_name}}	 --}}
											{{-- @dd($cart) --}}
    @if (!empty($cart->product_image) && !empty($cart->product_image->image_name))
        <img src="{{ asset('public/product_image/'.$cart->product_image->image_name) }}" class="img-fluid" style="max-width:100%; max-height:100%;" alt="{{ $cart->product_image->image_name }}">
    @else
        <img src="{{ asset('backend/img/thumbnail-default.jpg') }}" class="img-fluid" style="max-width:80px" alt="thumbnail-default.jpg">
    @endif
							...
							<div class="col-lg-8 col-md-5 col-12">
								<div class="left">
									...
									<form action="{{route('coupon-store')}}" method="POST">
											...
											<button class="btn text-light" style="background-color: #F7941D;">Apply</button>
										</form>
									</div>
									{{-- <div class="checkbox">`
										@php
