    ...
    <div id="carouselExampleIndicators" class="carousel slide">
        ...
        <div class="carousel-inner bg-transparent">
            ...
            <div class="carousel-item  @if( $key==0) active  @endif w-100 h-100">
                <img src="{{ asset('public/banner_image/'.$banner->bannerImages->image_name) }}" class="d-block w-100   object-fit-contain" alt="...">
            </div>
            @else
            <img src="{{ asset('public/banner_image/banner1.webp')}}" class="d-block w-100  object-fit-contain" alt="...">
            @endif
            @endforeach
      ...
      <img src="{{ asset('public/banner_image/banner1.webp')}}" class="d-block w-100 object-fit-contain" alt="...">
        ...
        <div class="carousel- w-100 h-100">
            <img src="{{ asset('public/banner_image/banner3.webp ')}}" class="d-block w-100 object-fit-contain" alt="...">
        </div> --}}
    </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="sum_banner">
                    <figure>
                        <img src="https://d1csarkz8obe9u.cloudfront.net/posterpreviews/summer-fashion-sale-banner-design-template-62077c541db2b288dbccd6d9d1c9af3d_screen.jpg?ts=1649932911" alt="">
                    </figure>
                </div>
            </div>
            <div class="col-md-4">
                <div class="sum_banner">
                    <figure>
                        <img src="https://img.freepik.com/free-vector/summer-colection-banner-with-hand-drawn-flowers_1188-312.jpg" alt="">
                    </figure>
                </div>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-12">
                <div class="product-info">
                    ...
                    <div class="tab-content flex-wrap mt-3   d-flex justify-content-center align-items-center  " id="myTabContent">
                        ...
                        <div class=" col-md-4 col-lg-3 col-sm-6 tab_content_mini  mt-3    px-0   isotope-item {{$product->cat_id}}">
