...
// Reset password
Route::post('password-reset', 'FrontendController@showResetForm')->name('custom.password.reset');
// Socialite
...
Route::get('/user/change-password', 'UserController@showChangePasswordForm')->name('user.change.password.form');
